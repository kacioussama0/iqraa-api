...
@section('content')
    ...
    <div class="container py-5">
        ...
        <h1 class="fw-bolder mb-5">
            <i class="fa-duotone fa-graduation-cap me-2"></i> {{ __('inscription.Inscription scolaire') }}
        </h1>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card rounded-5 border-0 shadow-sm">
                        ...
                        <h2 class="card-header text-success rounded-top-5 bg-primary-subtle border-primary-subtle">
                            <i class="fa-duotone fa-bullhorn me-2"></i> {{ __('inscription.Annonce importante aux parents') }}
                        </h2>
